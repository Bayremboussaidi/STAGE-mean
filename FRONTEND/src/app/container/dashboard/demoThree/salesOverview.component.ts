...
@Component({
  ...
  template: `
    <div
      class="bg-white dark:bg-white/10 m-0 p-0 text-theme-dark dark:text-white/60 text-[15px] rounded-10 relative "
    >
      <div
      ...
      <div class="p-[25px] pt-[20px]">
        <div *ngIf="sellingTab === 'today'">
          <div class="hexadash-chart-container" dir="ltr">
            ...
            ></apx-chart>
            <div
              class="flex justify-between items-center px-[15px] min-h-[76px] bg-regularBG dark:bg-white/10 rounded-[8px] mb-0 mt-[15px]"
            >
              <div class="text-center py-[5px] px-[15px]">
                <strong
                  class="font-semibold text-[18px] text-dark dark:text-white/[.87] inline-flex"
                  >{{ chartOptions.series[0] }}</strong
                >
                <div
                  class="text-[15px] font-normal leading-[1.6666666667] text-theme-gray dark:text-white/60 mb-0 flex items-center"
                >
              ...
              <div class="text-center py-[5px] px-[15px]">
                <strong
                  class="font-semibold text-[18px] text-dark dark:text-white/[.87] "
                  >{{ chartOptions.series[1] }}</strong
                >
                <div
                  class="text-[15px] font-normal leading-[1.6666666667] text-theme-gray dark:text-white/60 mb-0 flex items-center"
                >
          ...
          <div class="hexadash-chart-container" dir="ltr">
            ...
            >
              <div class="text-center py-[5px] px-[15px]">
                <strong
                  class="font-semibold text-[18px] text-dark dark:text-white/[.87] inline-flex"
                  >{{ chartOptions2.series[0] }}</strong
                >
                <div
                  class="text-[15px] font-normal leading-[1.6666666667] text-theme-gray dark:text-white/60 mb-0 flex items-center"
                >
                  {{ chartOptions2.labels[0] }}
                </div>
              </div>
              <div class="text-center py-[5px] px-[15px]">
                <strong
                  class="font-semibold text-[18px] text-dark dark:text-white/[.87] "
                  >{{ chartOptions2.series[1] }}</strong
                >
                <div
                  class="text-[15px] font-normal leading-[1.6666666667] text-theme-gray dark:text-white/60 mb-0 flex items-center"
                >
                  {{ chartOptions2.labels[1] }}
                </div>
              </div>
              <div class="text-center py-[5px] px-[15px]">
                <strong
                  class="font-semibold text-[18px] text-dark dark:text-white/[.87] "
                  >{{ chartOptions2.series[2] }}</strong
                >
                <div
                  class="text-[15px] font-normal leading-[1.6666666667] text-theme-gray dark:text-white/60 mb-0 flex items-center"
                >
                  {{ chartOptions2.labels[2] }}
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="hexadash-chart-container" dir="ltr">
            ...
            >
              <div class="text-center py-[5px] px-[15px]">
                <strong
                  class="font-semibold text-[18px] text-dark dark:text-white/[.87] inline-flex"
                  >{{ chartOptions3.series[0] }}</strong
                >
                <div
                  class="text-[15px] font-normal leading-[1.6666666667] text-theme-gray dark:text-white/60 mb-0 flex items-center"
                >
                  {{ chartOptions3.labels[0] }}
                </div>
              </div>
              <div class="text-center py-[5px] px-[15px]">
                <strong
                  class="font-semibold text-[18px] text-dark dark:text-white/[.87] "
                  >{{ chartOptions3.series[1] }}</strong
                >
                <div
                  class="text-[15px] font-normal leading-[1.6666666667] text-theme-gray dark:text-white/60 mb-0 flex items-center"
                >
                  {{ chartOptions3.labels[1] }}
                </div>
              </div>
              <div class="text-center py-[5px] px-[15px]">
                <strong
                  class="font-semibold text-[18px] text-dark dark:text-white/[.87] "
                  >{{ chartOptions3.series[2] }}</strong
                >
                <div
                  class="text-[15px] font-normal leading-[1.6666666667] text-theme-gray dark:text-white/60 mb-0 flex items-center"
                >
                  {{ chartOptions3.labels[2] }}
                </div>
              </div>
            </div>
          </div>
