...
import { AreaChartComponent } from '../container/dashboard/demoOne/area-chart';

import { DoughnutChartComponent } from '../container/dashboard/demoOne/doughnut-chart';
import { RadarChartComponent } from '../container/dashboard/demoOne/radar-chart';
...
@NgModule({
  imports: [CommonModule, SharedModule, DashboardRoutingModule, ...antdModule],
  exports: [
