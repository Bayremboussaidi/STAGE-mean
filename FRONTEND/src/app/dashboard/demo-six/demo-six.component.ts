...
export class DemoSixComponent {
  ...
  customColors1: string[] = ['#9fc327']; // Custom colors for Chart 1
  ...
  chartStatusIcon1: string =
    '../../assets/images/svg/unicons-line/arrow-up.svg';

  // Chart status data for Chart 1
  chartStatusNumber2: string = '10550';
  chartStatus2: string = 'success';
  chartStatusPercent2: string = '60';
  chartStatusIcon2: string =
    '../../assets/images/svg/unicons-line/arrow-up.svg';
  ...
  chartStatusIcon3: string =
    '../../assets/images/svg/unicons-line/arrow-down.svg';
}
