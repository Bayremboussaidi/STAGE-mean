...
@Component({
  ...
  template: `
    ...
    >
      <div
        class="mb-[26px] pb-[30px] border-b border-regular dark:border-white/10"
      >
          ...
          <div nz-col nzXXl="12" nzLg="16" nzXs="24">
            <nz-form-control class="mb-[20px]">
              ...
              <input
                ...
                placeholder="Duran "
              />
              <p class="mt-[14px] text-light dark:text-white/60">
                Your Dashboard URL: http://dashboard.com/<span
                  class="text-dark dark:text-white/[.87]"
                  >clayton</span
                >
              </p>
            </nz-form-control>
        ...
        <div nz-row nzJustify="center">
          <div nz-col nzXXl="12" nzLg="16" nzXs="24">
            <div class="flex items-center flex-wrap justify-between gap-[15px]">
              <div>
                <h1
                  class="text-base font-semibold text-dark dark:text-white/[.87]"
                >
                  Close Account
                </h1>
                <p class="mb-0 text-body dark:text-white/60">
