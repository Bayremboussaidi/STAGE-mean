...
@Component({
  ...
  template: `
    <button
      [routerLink]="['/apps/supports/support']"
      nz-button
    ...
    >
      <svg-icon
        class="w-[22px] h-[22px] text-dark dark:text-white/[.87] text-[14px] group-hover:text-primary"
        src="assets/images/svg/unicons-line/arrow-left.svg"
      ></svg-icon>
